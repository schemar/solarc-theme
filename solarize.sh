...
#REPLACE[$A_BLUE]=$S_BLUE # Duplicate of $A_SELECTED_BG
REPLACE[$A_WHITE]=$S_BASE3
REPLACE[$A_GREY]=$S_BASE2
#REPLACE[$A_DARK]=$S_BASE03 # Duplicate of $A_BG
#REPLACE[$A_DARKEST]=$S_BASE03 # Duplicate of $A_WM_ICON_CLOSE_BG
REPLACE[$A_DARKEST2]=$S_BASE03
REPLACE[$A_DARK_BUTTON]=$S_BASE03
REPLACE[$A_LIGHT_BUTTON]=$S_BASE02
REPLACE[$A_OTHER_LIGHT_BUTTON]=$S_BASE02
...
REPLACE[$A_ASSET_LIGHTER_BG]=$S_BASE02
REPLACE[$A_ASSET_LIGHTER_BG_FIX]=$S_BASE02
